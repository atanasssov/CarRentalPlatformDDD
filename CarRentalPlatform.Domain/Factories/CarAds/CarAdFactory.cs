...
namespace CarRentalPlatform.Domain.Factories.CarAds
{
    internal class CarAdFactory : ICarAdFactory
    {
        ...
        {
            return this.WithManufacturer(new Manufacturer(name));
        }
        ...
        {
            return this.WithCategory(new Category(name, description));
        }
        ...
        {
            return this.WithOptions(new Options(hasClimateControl, numberOfSeats, transmissionType));
        }
